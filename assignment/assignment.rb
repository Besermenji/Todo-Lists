...
class Assignment
  ...
  def create_user(params)
      ...
      # return an instance of the class with primary key (`id`), and dates (`created_at` and `updated_at`) assigne
	  @testUser = User.create(params) 
  ...
  def find_allusers(offset, limit)
      ...
      # return a collection of User instances that represent the specified row
